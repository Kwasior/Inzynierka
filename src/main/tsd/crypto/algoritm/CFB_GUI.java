...
public class CFB_GUI extends HorizontalLayout implements View {
    ...
    public FileResource resource2 = new FileResource(new File(basepath + "/WEB-INF/images/Ek2.png"));
    ...
    Image image10 = new Image("", resource2);
    ...
    public CFB_GUI() {
        ...
        vertical3.setWidth("105px");
        vertical5.setWidth("105px");
    ...
    private void display() {
        ...
        byte[] wyniktmp = AES_CFB.encrypt(tekst.getBytes(), key.getBytes(), ive);
        if (!tekstPole.isEmpty()) {
            ...
            if (!tekstPole2.isEmpty()) {
                ...
                byte[] ek2 = new byte[16];

                for (int m = 0; m < 16; m++) {
                    ek2[m] = wyniktmp[m];
                }
                byte[][] ek22 = AES.encrypt(ek2, key.getBytes());
                for (int m = 0; m < 16; m++) {
                    ek2[m] = ek22[4][m + 144];
                }
                for (byte b : ek2) {
            ...
            if (!tekstPole3.isEmpty()) {
                byte[] ek3 = new byte[16];

                for (int m = 0; m < 16; m++) {
                    ek3[m] = wyniktmp[m + 16];
                }
                byte[][] ek33 = AES.encrypt(ek3, key.getBytes());
                for (int m = 0; m < 16; m++) {
                    ek3[m] = ek33[4][m + 144];
                }
                for (byte b : ek3) {
            ...
            if (!tekstPole4.isEmpty()) {
                byte[] ek4 = new byte[16];

                for (int m = 0; m < 16; m++) {
                    ek4[m] = wyniktmp[m + 32];
                }
                byte[][] ek44 = AES.encrypt(ek4, key.getBytes());
                for (int m = 0; m < 16; m++) {
                    ek4[m] = ek44[4][m + 144];
                }
                for (byte b : ek4) {
